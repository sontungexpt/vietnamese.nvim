...
local VN_CODEC = {
	...
	-- a / ă / â
	----------------------------------------------------------------------
	-- 0b0_000_000_001 = 0x001
	["a"] = 0x001,
	[0x001] = "a",
	-- 0b0_001_000_001 = 0x041
	["á"] = 0x041,
	[0x041] = "á",
	-- 0b0_010_000_001 = 0x081
	["à"] = 0x081,
	[0x081] = "à",
	-- 0b0_011_000_001 = 0x0C1
	["ả"] = 0x0C1,
	[0x0C1] = "ả",
	-- 0b0_100_000_001 = 0x101
	["ã"] = 0x101,
	[0x101] = "ã",
	-- 0b0_101_000_001 = 0x141
	["ạ"] = 0x141,
	[0x141] = "ạ",

	-- 0b0_000_010_001 = 0x021
	["ă"] = 0x021,
	[0x021] = "ă",
	-- 0b0_001_010_001 = 0x061
	["ắ"] = 0x061,
	[0x061] = "ắ",
	-- 0b0_010_010_001 = 0x0A1
	["ằ"] = 0x0A1,
	[0x0A1] = "ằ",
	-- 0b0_011_010_001 = 0x0E1
	["ẳ"] = 0x0E1,
	[0x0E1] = "ẳ",
	-- 0b0_100_010_001 = 0x121
	["ẵ"] = 0x121,
	[0x121] = "ẵ",
	-- 0b0_101_010_001 = 0x161
	["ặ"] = 0x161,
	[0x161] = "ặ",

	-- 0b0_000_001_001 = 0x009
	["â"] = 0x009,
	[0x009] = "â",
	-- 0b0_001_001_001 = 0x049
	["ấ"] = 0x049,
	[0x049] = "ấ",
	-- 0b0_010_001_001 = 0x089
	["ầ"] = 0x089,
	[0x089] = "ầ",
	-- 0b0_011_001_001 = 0x0C9
	["ẩ"] = 0x0C9,
	[0x0C9] = "ẩ",
	-- 0b0_100_001_001 = 0x109
	["ẫ"] = 0x109,
	[0x109] = "ẫ",
	-- 0b0_101_001_001 = 0x149
	["ậ"] = 0x149,
	[0x149] = "ậ",
	...
	-- e / ê
	----------------------------------------------------------------------
	-- 0b0_000_000_010 = 0x002
	["e"] = 0x002,
	[0x002] = "e",
	-- 0b0_001_000_010 = 0x042
	["é"] = 0x042,
	[0x042] = "é",
	-- 0b0_010_000_010 = 0x082
	["è"] = 0x082,
	[0x082] = "è",
	-- 0b0_011_000_010 = 0x0C2
	["ẻ"] = 0x0C2,
	[0x0C2] = "ẻ",
	-- 0b0_100_000_010 = 0x102
	["ẽ"] = 0x102,
	[0x102] = "ẽ",
	-- 0b0_101_000_010 = 0x142
	["ẹ"] = 0x142,
	[0x142] = "ẹ",

	-- 0b0_000_001_010 = 0x00A
	["ê"] = 0x00A,
	[0x00A] = "ê",
	-- 0b0_001_001_010 = 0x04A
	["ế"] = 0x04A,
	[0x04A] = "ế",
	-- 0b0_010_001_010 = 0x08A
	["ề"] = 0x08A,
	[0x08A] = "ề",
	-- 0b0_011_001_010 = 0x0CA
	["ể"] = 0x0CA,
	[0x0CA] = "ể",
	-- 0b0_100_001_010 = 0x10A
	["ễ"] = 0x10A,
	[0x10A] = "ễ",
	-- 0b0_101_001_010 = 0x14A
	["ệ"] = 0x14A,
	[0x14A] = "ệ",
	...
	-- i
	----------------------------------------------------------------------
	-- 0b0_000_000_011 = 0x003
	["i"] = 0x003,
	[0x003] = "i",
	-- 0b0_001_000_011 = 0x043
	["í"] = 0x043,
	[0x043] = "í",
	-- 0b0_010_000_011 = 0x083
	["ì"] = 0x083,
	[0x083] = "ì",
	-- 0b0_011_000_011 = 0x0C3
	["ỉ"] = 0x0C3,
	[0x0C3] = "ỉ",
	-- 0b0_100_000_011 = 0x103
	["ĩ"] = 0x103,
	[0x103] = "ĩ",
	-- 0b0_101_000_011 = 0x143
	["ị"] = 0x143,
	[0x143] = "ị",
	...
	-- o / ô / ơ
	----------------------------------------------------------------------
	-- 0b0_000_000_100 = 0x004
	["o"] = 0x004,
	[0x004] = "o",
	-- 0b0_001_000_100 = 0x044
	["ó"] = 0x044,
	[0x044] = "ó",
	-- 0b0_010_000_100 = 0x084
	["ò"] = 0x084,
	[0x084] = "ò",
	-- 0b0_011_000_100 = 0x0C4
	["ỏ"] = 0x0C4,
	[0x0C4] = "ỏ",
	-- 0b0_100_000_100 = 0x104
	["õ"] = 0x104,
	[0x104] = "õ",
	-- 0b0_101_000_100 = 0x144
	["ọ"] = 0x144,
	[0x144] = "ọ",

	-- 0b0_000_001_100 = 0x00C
	["ô"] = 0x00C,
	[0x00C] = "ô",
	-- 0b0_001_001_100 = 0x04C
	["ố"] = 0x04C,
	[0x04C] = "ố",
	-- 0b0_010_001_100 = 0x08C
	["ồ"] = 0x08C,
	[0x08C] = "ồ",
	-- 0b0_011_001_100 = 0x0CC
	["ổ"] = 0x0CC,
	[0x0CC] = "ổ",
	-- 0b0_100_001_100 = 0x10C
	["ỗ"] = 0x10C,
	[0x10C] = "ỗ",
	-- 0b0_101_001_100 = 0x14C
	["ộ"] = 0x14C,
	[0x14C] = "ộ",

	-- 0b0_000_011_100 = 0x01C
	["ơ"] = 0x01C,
	[0x01C] = "ơ",
	-- 0b0_001_011_100 = 0x05C
	["ớ"] = 0x05C,
	[0x05C] = "ớ",
	-- 0b0_010_011_100 = 0x09C
	["ờ"] = 0x09C,
	[0x09C] = "ờ",
	-- 0b0_011_011_100 = 0x0DC
	["ở"] = 0x0DC,
	[0x0DC] = "ở",
	-- 0b0_100_011_100 = 0x11C
	["ỡ"] = 0x11C,
	[0x11C] = "ỡ",
	-- 0b0_101_011_100 = 0x15C
	["ợ"] = 0x15C,
	[0x15C] = "ợ",
	...
	-- u / ư
	----------------------------------------------------------------------
	-- 0b0_000_000_101 = 0x005
	["u"] = 0x005,
	[0x005] = "u",
	-- 0b0_001_000_101 = 0x045
	["ú"] = 0x045,
	[0x045] = "ú",
	-- 0b0_010_000_101 = 0x085
	["ù"] = 0x085,
	[0x085] = "ù",
	-- 0b0_011_000_101 = 0x0C5
	["ủ"] = 0x0C5,
	[0x0C5] = "ủ",
	-- 0b0_100_000_101 = 0x105
	["ũ"] = 0x105,
	[0x105] = "ũ",
	-- 0b0_101_000_101 = 0x145
	["ụ"] = 0x145,
	[0x145] = "ụ",

	-- 0b0_000_011_101 = 0x01D
	["ư"] = 0x01D,
	[0x01D] = "ư",
	-- 0b0_001_011_101 = 0x05D
	["ứ"] = 0x05D,
	[0x05D] = "ứ",
	-- 0b0_010_011_101 = 0x09D
	["ừ"] = 0x09D,
	[0x09D] = "ừ",
	-- 0b0_011_011_101 = 0x0DD
	["ử"] = 0x0DD,
	[0x0DD] = "ử",
	-- 0b0_100_011_101 = 0x11D
	["ữ"] = 0x11D,
	[0x11D] = "ữ",
	-- 0b0_101_011_101 = 0x15D
	["ự"] = 0x15D,
	[0x15D] = "ự",
	...
	-- y
	----------------------------------------------------------------------
	-- 0b0_000_000_110 = 0x006
	["y"] = 0x006,
	[0x006] = "y",
	-- 0b0_001_000_110 = 0x046
	["ý"] = 0x046,
	[0x046] = "ý",
	-- 0b0_010_000_110 = 0x086
	["ỳ"] = 0x086,
	[0x086] = "ỳ",
	-- 0b0_011_000_110 = 0x0C6
	["ỷ"] = 0x0C6,
	[0x0C6] = "ỷ",
	-- 0b0_100_000_110 = 0x106
	["ỹ"] = 0x106,
	[0x106] = "ỹ",
	-- 0b0_101_000_110 = 0x146
	["ỵ"] = 0x146,
	[0x146] = "ỵ",
	...
	-- d / đ
	----------------------------------------------------------------------
	-- 0b0_000_000_111 = 0x007
	["d"] = 0x007,
	[0x007] = "d",
	-- 0b0_000_100_111 = 0x04F
	["đ"] = 0x04F,
	[0x04F] = "đ",
	...
	----------------------------------------------------------------------
	-- 0b1_000_000_001 = 0x201
	["A"] = 0x201,
	[0x201] = "A",
	-- 0b1_001_000_001 = 0x241
	["Á"] = 0x241,
	[0x241] = "Á",
	-- 0b1_010_000_001 = 0x281
	["À"] = 0x281,
	[0x281] = "À",
	-- 0b1_011_000_001 = 0x2C1
	["Ả"] = 0x2C1,
	[0x2C1] = "Ả",
	-- 0b1_100_000_001 = 0x301
	["Ã"] = 0x301,
	[0x301] = "Ã",
	-- 0b1_101_000_001 = 0x341
	["Ạ"] = 0x341,
	[0x341] = "Ạ",

	-- 0b1_000_010_001 = 0x221
	["Ă"] = 0x221,
	[0x221] = "Ă",
	-- 0b1_001_010_001 = 0x261
	["Ắ"] = 0x261,
	[0x261] = "Ắ",
	-- 0b1_010_010_001 = 0x2A1
	["Ằ"] = 0x2A1,
	[0x2A1] = "Ằ",
	-- 0b1_011_010_001 = 0x2E1
	["Ẳ"] = 0x2E1,
	[0x2E1] = "Ẳ",
	-- 0b1_100_010_001 = 0x321
	["Ẵ"] = 0x321,
	[0x321] = "Ẵ",
	-- 0b1_101_010_001 = 0x361
	["Ặ"] = 0x361,
	[0x361] = "Ặ",

	-- 0b1_000_001_001 = 0x209
	["Â"] = 0x209,
	[0x209] = "Â",
	-- 0b1_001_001_001 = 0x249
	["Ấ"] = 0x249,
	[0x249] = "Ấ",
	-- 0b1_010_001_001 = 0x289
	["Ầ"] = 0x289,
	[0x289] = "Ầ",
	-- 0b1_011_001_001 = 0x2C9
	["Ẩ"] = 0x2C9,
	[0x2C9] = "Ẩ",
	-- 0b1_100_001_001 = 0x309
	["Ẫ"] = 0x309,
	[0x309] = "Ẫ",
	-- 0b1_101_001_001 = 0x349
	["Ậ"] = 0x349,
	[0x349] = "Ậ",

	-- 0b1_000_000_010 = 0x202
	["E"] = 0x202,
	[0x202] = "E",
	-- 0b1_001_000_010 = 0x242
	["É"] = 0x242,
	[0x242] = "É",
	-- 0b1_010_000_010 = 0x282
	["È"] = 0x282,
	[0x282] = "È",
	-- 0b1_011_000_010 = 0x2C2
	["Ẻ"] = 0x2C2,
	[0x2C2] = "Ẻ",
	-- 0b1_100_000_010 = 0x302
	["Ẽ"] = 0x302,
	[0x302] = "Ẽ",
	-- 0b1_101_000_010 = 0x342
	["Ẹ"] = 0x342,
	[0x342] = "Ẹ",

	-- 0b1_000_001_010 = 0x20A
	["Ê"] = 0x20A,
	[0x20A] = "Ê",
	-- 0b1_001_001_010 = 0x24A
	["Ế"] = 0x24A,
	[0x24A] = "Ế",
	-- 0b1_010_001_010 = 0x28A
	["Ề"] = 0x28A,
	[0x28A] = "Ề",
	-- 0b1_011_001_010 = 0x2CA
	["Ể"] = 0x2CA,
	[0x2CA] = "Ể",
	-- 0b1_100_001_010 = 0x30A
	["Ễ"] = 0x30A,
	[0x30A] = "Ễ",
	-- 0b1_101_001_010 = 0x34A
	["Ệ"] = 0x34A,
	[0x34A] = "Ệ",

	-- 0b1_000_000_011 = 0x203
	["I"] = 0x203,
	[0x203] = "I",
	-- 0b1_001_000_011 = 0x243
	["Í"] = 0x243,
	[0x243] = "Í",
	-- 0b1_010_000_011 = 0x283
	["Ì"] = 0x283,
	[0x283] = "Ì",
	-- 0b1_011_000_011 = 0x2C3
	["Ỉ"] = 0x2C3,
	[0x2C3] = "Ỉ",
	-- 0b1_100_000_011 = 0x303
	["Ĩ"] = 0x303,
	[0x303] = "Ĩ",
	-- 0b1_101_000_011 = 0x343
	["Ị"] = 0x343,
	[0x343] = "Ị",

	-- 0b1_000_000_100 = 0x204
	["O"] = 0x204,
	[0x204] = "O",
	-- 0b1_001_000_100 = 0x244
	["Ó"] = 0x244,
	[0x244] = "Ó",
	-- 0b1_010_000_100 = 0x284
	["Ò"] = 0x284,
	[0x284] = "Ò",
	-- 0b1_011_000_100 = 0x2C4
	["Ỏ"] = 0x2C4,
	[0x2C4] = "Ỏ",
	-- 0b1_100_000_100 = 0x304
	["Õ"] = 0x304,
	[0x304] = "Õ",
	-- 0b1_101_000_100 = 0x344
	["Ọ"] = 0x344,
	[0x344] = "Ọ",

	-- 0b1_000_001_100 = 0x20C
	["Ô"] = 0x20C,
	[0x20C] = "Ô",
	-- 0b1_001_001_100 = 0x24C
	["Ố"] = 0x24C,
	[0x24C] = "Ố",
	-- 0b1_010_001_100 = 0x28C
	["Ồ"] = 0x28C,
	[0x28C] = "Ồ",
	-- 0b1_011_001_100 = 0x2CC
	["Ổ"] = 0x2CC,
	[0x2CC] = "Ổ",
	-- 0b1_100_001_100 = 0x30C
	["Ỗ"] = 0x30C,
	[0x30C] = "Ỗ",
	-- 0b1_101_001_100 = 0x34C
	["Ộ"] = 0x34C,
	[0x34C] = "Ộ",

	-- 0b1_000_011_100 = 0x21C
	["Ơ"] = 0x21C,
	[0x21C] = "Ơ",
	-- 0b1_001_011_100 = 0x25C
	["Ớ"] = 0x25C,
	[0x25C] = "Ớ",
	-- 0b1_010_011_100 = 0x29C
	["Ờ"] = 0x29C,
	[0x29C] = "Ờ",
	-- 0b1_011_011_100 = 0x2DC
	["Ở"] = 0x2DC,
	[0x2DC] = "Ở",
	-- 0b1_100_011_100 = 0x31C
	["Ỡ"] = 0x31C,
	[0x31C] = "Ỡ",
	-- 0b1_101_011_100 = 0x35C
	["Ợ"] = 0x35C,
	[0x35C] = "Ợ",

	-- 0b1_000_000_101 = 0x205
	["U"] = 0x205,
	[0x205] = "U",
	-- 0b1_001_000_101 = 0x245
	["Ú"] = 0x245,
	[0x245] = "Ú",
	-- 0b1_010_000_101 = 0x285
	["Ù"] = 0x285,
	[0x285] = "Ù",
	-- 0b1_011_000_101 = 0x2C5
	["Ủ"] = 0x2C5,
	[0x2C5] = "Ủ",
	-- 0b1_100_000_101 = 0x305
	["Ũ"] = 0x305,
	[0x305] = "Ũ",
	-- 0b1_101_000_101 = 0x345
	["Ụ"] = 0x345,
	[0x345] = "Ụ",

	-- 0b1_000_011_101 = 0x21D
	["Ư"] = 0x21D,
	[0x21D] = "Ư",
	-- 0b1_001_011_101 = 0x25D
	["Ứ"] = 0x25D,
	[0x25D] = "Ứ",
	-- 0b1_010_011_101 = 0x29D
	["Ừ"] = 0x29D,
	[0x29D] = "Ừ",
	-- 0b1_011_011_101 = 0x2DD
	["Ử"] = 0x2DD,
	[0x2DD] = "Ử",
	-- 0b1_100_011_101 = 0x31D
	["Ữ"] = 0x31D,
	[0x31D] = "Ữ",
	-- 0b1_101_011_101 = 0x35D
	["Ự"] = 0x35D,
	[0x35D] = "Ự",

	-- 0b1_000_000_110 = 0x206
	["Y"] = 0x206,
	[0x206] = "Y",
	-- 0b1_001_000_110 = 0x246
	["Ý"] = 0x246,
	[0x246] = "Ý",
	-- 0b1_010_000_110 = 0x286
	["Ỳ"] = 0x286,
	[0x286] = "Ỳ",
	-- 0b1_011_000_110 = 0x2C6
	["Ỷ"] = 0x2C6,
	[0x2C6] = "Ỷ",
	-- 0b1_100_000_110 = 0x306
	["Ỹ"] = 0x306,
	[0x306] = "Ỹ",
	-- 0b1_101_000_110 = 0x346
	["Ỵ"] = 0x346,
	[0x346] = "Ỵ",

	-- 0b1_000_000_111 = 0x207
	["D"] = 0x207,
	[0x207] = "D",
	-- 0b1_000_100_111 = 0x24F
	["Đ"] = 0x24F,
	[0x24F] = "Đ",
}
...
M.diacritic_mergeable = function(c, diacritic)
	local code = VN_CODEC[c]
	--- @cast code integer
	return code and VN_CODEC[bor(code, diacritic)] ~= nil or false
end
...
M.merge_diacritic = function(c, diacritic, strip_shape_too)
	...
	--- @cast code integer
	---@diagnostic disable-next-line: return-type-mismatch
	return code and VN_CODEC[bor(code, diacritic)] or c
end
...
M.is_vn_vowel = function(c)
	return #c < 4 and c ~= "đ" and c ~= "Đ" and VN_CODEC[c] ~= nil
end
